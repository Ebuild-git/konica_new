    ...
    <div class="container">
       {{--  <div class="header">
        ...
        <div class="content">
            ...
            <p>
                {{ \App\Helpers\TranslationHelper::TranslateText('Nous sommes ravis de vous compter parmi nos nouveaux membres. Chez KONICA, nous nous engageons à vous fournir le meilleur  pour répondre à tous vos besoins.
               ') }} 
            </p>
            <p>
